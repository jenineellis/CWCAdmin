      ...
      <div id="about">
        ...
        <div className="scroll">
          <p>
            ...
            Marta Tomaras, an Experienced Wine Fan, who grew up with
            grandparents making their own wine; and Jenine Ellis — developed a
            concept to introduce lesser known and smaller batch producing
            vineyards to discerning wine consumers whose local shops, outside of
            California, might not represent these wonderful products.
          </p>

          <p>
            We showcase the work of winegrowers committed to natural farming,
            small production, and the traditions of their respective regions.
            Many of the producers we represent are considered among the finest
            in the world. Through our personal relationship with these small
            family farms, the wines come directly from the cellars under perfect
